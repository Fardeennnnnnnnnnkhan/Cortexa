      ...
      <nav ref={navRef} className={`card-nav ${isExpanded ? 'open' : ''}`} style={{ backgroundColor: baseColor }}>
        <div className="card-nav-top">
          ...
          <div className="nav-actions">
            <div className="right-content-slot">
              {rightContent}
            </div>
            
            <button
              className={`hamburger-toggle ${isExpanded ? 'open' : ''}`}
              onClick={toggleMenu}
            ...
            >
              ...
              <div className="nav-card-links">
                {item.links?.map((lnk, i) => (
                  <a key={`${lnk.label}-${i}`} className="nav-card-link" href={lnk.href} style={{ color: item.textColor }}>
